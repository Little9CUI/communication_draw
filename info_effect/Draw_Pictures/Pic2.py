...
def main(args):
    ...
    for i in range(1):
        ...
        x_smooth = np.linspace(0, args.max_step, len(uncertainties_all[i]) * 5)
        y1_smooth = make_interp_spline(x, uncertainties_all[i])(x_smooth)
        # plt.plot(uncertainties_all[i])
        perLable = "Correct one error"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_step', default=25, type=int, help='最大步长')
